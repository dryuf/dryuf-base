...
/**
 * {@link ListeningExecutorService} which forwards all its action to provided {@link ExecutorService}.
 *
 * @author
 * 	Zbynek Vyskovsky, mailto:kvr@centrum.cz http://kvr.znj.cz/software/java/ListenableFuture/ http://github.com/kvr000
 */
public class ForwardingListeningExecutorService extends AbstractListeningExecutorService
{
	public                          ForwardingListeningExecutorService(ExecutorService executor)
	{
